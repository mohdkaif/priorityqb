...
.modal-header { display: flex; align-items: center; justify-content: space-between; padding: 1rem 1.25rem; background: linear-gradient(135deg,#0a4d68,#088395); color: #fff; border-radius: 14px 14px 0 0; }
.modal-title { margin: 0; font-size: 1.15rem; font-weight: 700; }
.modal-body { padding: 1.25rem; }
.modal-footer { display: flex; justify-content: flex-end; padding: 1rem 1.25rem; border-top: 1px solid #dce5ee; }
...
body .btn-primary { background: linear-gradient(135deg,#0a4d68,#088395) !important; border: none !important; color: #fff !important; font-weight: 700 !important; padding: .75rem 1.5rem !important; border-radius: 10px !important; cursor: pointer; min-height: 44px; }
`;
