                                    ...
                                    <div class="full graph_head">
                                        <div class="heading1 margin_0">
                                            ...
                                            <a href="add_reviews.php">
                                                <button type="button" class="btn btn-icon btn-sm js-sweetalert">Add More Reviews</button>
                                            </a>
                                        </div>
                                     </div>
                                    <div class="table_section padding_infor_info">
                                        <div class="table-responsive-sm">
                                            <table class="table table-dark">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql=mysqli_query($conn ,"SELECT * FROM `tbl_testimonial`"); 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="update_reviews.php?id=<?php echo $row['id']; ?>">
                                                            <i class="fa fa-edit fa-2x text-primary"></i>
                                                            </a>
                                                        </td>
                                                        <td>
                                                            <a href="delete_reviews.php?id=<?php echo $row['id']; ?>">
