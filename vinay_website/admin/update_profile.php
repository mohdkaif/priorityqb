            ...
            <!-- dashboard inner -->
                                     ...
                                     <div class="login_form">
                                         <form action="" method="POST">
                                             ...
                                             <div class="field">
                                                 ...
                                                 <input type="text" name="name" placeholder="Name" value="<?php echo $result1['name']; ?>" required/>
                                             </div>
                                             <div class="field">
                                                 <label class="label_field">Email</label>
                                                 <input type="text" name="email" placeholder="Email" value="<?php echo $result1['email']; ?>" />
                                             </div>
                                             <div class="field">
                                                 <label class="label_field">Password</label>
                                                 <input type="text" name="password" placeholder="Password" value="<?php echo $result1['password']; ?>" required/>
                                             </div>
             ...
             <?php
                 ...
                 {   
                     ...
                     $iquery = "update tbl_user set name = '$name',email='$email',password='$password' where id = '$id'";
