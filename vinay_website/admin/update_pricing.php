...
<?php
   ...
   $no = $_GET['id'];
   $query = mysqli_query($conn,"select * from tbl_pricing where id = '$no'");
               ...
               <!-- dashboard inner -->
                                        ...
                                        <div class="login_form">
                                            <form action="" method="POST">
                                                ...
                                                <div class="field">
                                                    ...
                                                    <input type="text" name="name" placeholder="Service Name" value="<?php echo $result['product_name']; ?>" required/>
                                                </div>
                                                <div class="field">
                                                    <label class="label_field">Duration</label>
                                                    <input type="text" name="duration" placeholder="Duration" value="<?php echo $result['duration']; ?>" />
                                                </div>
                                                <div class="field">
                ...
                <?php
                    ...
                    {   
                        ...
                        $price=$_POST['price'];
                        $iquery = "update tbl_pricing set product_name = '$name',duration='$duration',price='$price' where id = '$id'";
