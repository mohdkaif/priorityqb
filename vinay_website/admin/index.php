                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30 yellow_bg">
                              ...
                              <div class="counter_no">
                                 <div>
                                    <p class="head_couter">Pricing</p>
                                    <p class="total_no"><?php  echo "$rowcount"; ?></p>  
                                 </div>
                              </div>
                           </div>
                        </div>
                        <?php
                           $result1 = mysqli_query($conn,"SELECT * FROM tbl_testimonial");
                           ...
                           <div class="full counter_section margin_bottom_30 blue1_bg">
                              ...
                              <div class="counter_no">
                                 <div>
                                    ...
                                    <p class="total_no"><?php  echo "$rowcount1"; ?></p>                                 
                                 </div>
                              </div>
                           </div>
                        </div>
