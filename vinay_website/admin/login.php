<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $login = mysqli_query($conn,"select * from tbl_user where email = '$username' and password = '$password'");
        ...
        if($result){
            ...
            echo '<script type="text/javacript"> alert("Invalid Username or Password")</script>';
        }
    }   
?>
