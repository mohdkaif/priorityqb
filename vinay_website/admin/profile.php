                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table table-dark">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="password" disabled style="background-color:black;color:white" value="<?php echo $row["password"];?>" id="myInput"></td>
                                                    <td><input type="checkbox" onclick="myFunction()">Show Password</td>
                                                </tr>
                                                <tr>
                                                    <td colspan=3 align="center">
                                                        <a href="update_profile.php?id=<?php echo $row['id']; ?>">
                                                            <button type="submit" name="submit" style="width:150px" class="btn btn-primary">Edit</button>
                                                        </a>
                                                    </td>
                                                </tr>
                                                <?php
